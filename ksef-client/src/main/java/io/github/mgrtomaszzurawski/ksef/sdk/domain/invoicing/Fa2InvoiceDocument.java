 ...
 *
 * <p>Accessors mirror the FA(2) {@code <Faktura>} XSD shape and return
 * JAXB raw types directly. PR21 will replace these with SDK-owned
 * sub-records pre-1.0; the {@link #faktura()} escape-hatch survives.
 *
 * @since 1.0.0
 */
public final class Fa2InvoiceDocument implements InvoiceDocument {
    ...
    /** The underlying JAXB tree. Read-only access. */
