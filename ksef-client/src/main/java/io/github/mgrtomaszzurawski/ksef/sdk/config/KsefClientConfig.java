...
/**
 * Immutable snapshot of how a {@link KsefClient} was configured at
 * {@code build()} time. Returned by {@link KsefClient#config()} so
 * consumers can:
 *
 * <ul>
 ...
 * {@code equals}/{@code hashCode} — it is a {@link AutoCloseable}
...
public record KsefClientConfig(
        ...
        boolean hasOfflineSigningProvider) {
}
